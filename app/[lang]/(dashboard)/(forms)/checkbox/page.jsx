...
// import { database } from '../../../../../utills/includes/firebase'; // Import the database instance
const CheckBoxPage = () => {
  // function addDataToRealtimeDB(userId, name, email) {
  //   console.log('first======================>', { userId, name, email });
  ...
  // Usage Example:
  // const onSubmit = () => {
  //   addDataToRealtimeDB('user1', 'John Doe', 'john.doe@example.com');
  // };
  return (
      ...
      <div className=' grid grid-cols-1 xl:grid-cols-2 gap-6'>
        <Card title='Default Checkbox' code={defaultCheckbox}>
          <p className='text-sm text-default-400 dark:text-default-600  mb-4'>
            {/* <code className='text-primary' onClick={onSubmit}> */}
